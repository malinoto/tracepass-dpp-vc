...
[![Fields](https://img.shields.io/badge/properties-911-informational)](#status)
...
document** — 911 `characteristics` properties in total. `node scripts/validate.mjs`
...
| | |
|---|---|
| Properties | 911 across 13 categories |
| Citing an EU instrument or standard | 905 (99%) |
| Carrying a verified QUDT unit IRI | 219 |
